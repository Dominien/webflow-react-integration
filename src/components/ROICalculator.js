        ...
        <div className="card-content">
          ...
          <div className="button-container">
            <button onClick={calculateResults} className="calculate-button">
              <span className="button-icon">🧮</span> Ergebnisse berechnen
            </button>
          </div>
        </div>
      </div>
        ...
        <div id="results-section" className="results-container">
          ...
          <div className="results-grid">
            <div className="results-card">
              <div className="card-header">
                <h2 className="card-title">
                  <span className="title-icon">€</span> Umsatzübersicht
                </h2>
            ...
            <div className="results-card">
              <div className="card-header">
                <h2 className="card-title">
                  <span className="title-icon">📊</span> Umsatzvisualisierung
                </h2>
          ...
          {showAdvancedOptions && breakEvenMonths > 0 && (
            <div className="results-card">
              <div className="card-header">
                <h2 className="card-title">
                  <span className="title-icon">⏱️</span> Amortisationsanalyse
                </h2>
          ...
          <div className="download-section">
            <button className="download-button">
              <span className="button-icon">📥</span> Bericht herunterladen
            </button>
          </div>
        </div>
      )}
